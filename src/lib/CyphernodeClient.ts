...
class CyphernodeClient {
  ...
  async validateAddress(address: string): Promise<IRespValidateAddress> {
    ...
    //
    // Example of valid address result:
    //
    // {
    //   "result": {
    //     "isvalid": true,
    ...
    //     "iswitness": true,
    //     "witness_version": 1,
    //     "witness_program": "3daaca9b82a51aca960c1491588246029d7e0fc49e0abdbcc8fd17574be5c74b"
    //   },
    //   "error": null,
    //   "id": null
    // }
    //
    // Example of invalid address result:
    //
    // {
    //   "result": {
    //     "isvalid": false,
    //     "error_locations": [],
    //     "error": "Not a valid Bech32 or Base58 encoding"
    //   },
    //   "error": null,
    //   "id": null
    // }
    ...
    let result: IRespValidateAddress;
