...
class LnServicePayValidator {
  static validateRequest(lnurlPay: LnurlPayEntity, request: IReqCreateLnurlPayRequest): boolean {
    if (request.amount >= lnurlPay.minMsatoshi && request.amount <= lnurlPay.maxMsatoshi) {
